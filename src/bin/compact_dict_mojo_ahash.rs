...
fn main() {
    ...
    let mut dic: Dict<i32, dict::ahash::MojoAHashStrHash> = Dict::new(N);
    // Insert
    ...
    let (program_name, file_name) = ("compact_dict_mojo_ahash.rs", "compact-dict-mojo-ahash-rs.json");
    ...
    let csv_path = Path::new("results").join("compact-dict-mojo-ahash-rs.csv");
